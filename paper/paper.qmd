...
## Datasheet
Accompanying the paper, a datasheet that contains an in-depth discussion of the nature of the dataset used (i.e. the Lahman Baseball Database) can be found in `other/datasheet/datasheet_lahman.pdf`.
